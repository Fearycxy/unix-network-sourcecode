...
void	 str_echo(int);//lib/str_echo.c
...
int		 Family_to_level(int);
struct addrinfo *Host_serv(const char *, const char *, int, int);
const char		*Inet_ntop(int, const void *, char *, size_t);//lib/wraplib.c
void			 Inet_pton(int, const char *, void *);//lib/wraplib.c
char			*If_indextoname(unsigned int, char *);
unsigned int		 If_nametoindex(const char *);
struct if_nameindex	*If_nameindex(void);
char   **My_addrs(int *);
...
void	 Fclose(FILE *);//lib/wrapstdio.c
FILE	*Fdopen(int, const char *);//lib/wrapstdio.c
char	*Fgets(char *, int, FILE *);//lib/wrapstdio.c
FILE	*Fopen(const char *, const char *);//lib/wrapstdio.c
void	 Fputs(const char *, FILE *);//lib/wrapstdio.c
...
#endif
ssize_t	 Readline(int, void *, size_t);//lib/readline.c
ssize_t	 Readn(int, void *, size_t);//readn.c
